...
\begin{document}
    ...
    A simple super-sampling anti-aliasing method that renders at a higher resolution and downsamples. This 
    relies on increasing the render resolution of each axis by a power of two (adjustable via \emph{SAMPLING\_FACTOR}),
